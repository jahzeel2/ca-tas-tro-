...
{
    public class MEDesgloseDestinoMapper : EntityTypeConfiguration<MEDesgloseDestino>
    {
        public MEDesgloseDestinoMapper()
        {
            this.ToTable("ME_DESGLOSE_DESTINO");

            this.HasKey(a => a.IdDesgloseDestino);
