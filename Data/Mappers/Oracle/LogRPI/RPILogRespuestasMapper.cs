...
{
    public class RPILogRespuestasMapper : EntityTypeConfiguration<RPILogRespuestas>
    {
        public RPILogRespuestasMapper()
        {
            this.ToTable("RPI_LOG_RESPUESTAS").HasKey(a => a.LogId);
