...
{
    public class SuperficieParcelaRuralValidation : IDDJJValidation
    { 
        private readonly GeoSITMContext _context;
        public SuperficieParcelaRuralValidation(GeoSITMContext ctx)
        {
            _context = ctx;
        }
        public Tuple<DDJJ,IEnumerable<string>> Validate(DDJJ ddjj)
        {
            ...
            var parcela = (from p in _context.Parcelas
                           where (from ut in _context.UnidadesTributarias
